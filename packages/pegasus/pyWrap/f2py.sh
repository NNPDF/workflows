...
Routines/asg2pmom.f Routines/ebetafct.f Routines/esg1n.f    Routines/evnvfn.f   Routines/initpinp.f Routines/inppmom1.f Routines/pns1mom.f  Routines/pnsg0mom.f Routines/usg1hmom.f Routines/xparton.f'
...
if [ "$MODE" -eq "1" ]; then
  f2py3 --overwrite-signature \
    ...
    only: initevol initinp xparton as betafct
fi
